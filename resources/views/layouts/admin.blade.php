...
<header class="app-header sticky" id="header">
    ...
    <div class="main-header-container container-fluid">
        ...
        <ul class="header-content-right">
            ...
            <!-- Start::header-element -->
            <li class="header-element notifications-dropdown d-xl-block d-none dropdown d-none">
                <!-- Start::header-link|dropdown-toggle -->
                <a href="javascript:void(0);" class="header-link dropdown-toggle d-none" data-bs-toggle="dropdown"
            ...
            <li class="header-element dropdown">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-xl-2 me-0 lh-1 d-flex align-items-center ">
                            <span class="avatar avatar-xs avatar-rounded bg-primary-transparent">
                                <?php
                                    $name = \Auth::user()->full_name ?: \Auth::user()->email; // e.g., "Rahul Chauhan"
                        ...
                        <div class="d-xl-block d-none lh-1">
                            <span class="fw-medium lh-1">{{ \Auth::user()->full_name ?: \Auth::user()->email }}</span>
                        </div>
                    </div>
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li class="border-bottom"><a class="dropdown-item d-flex flex-column" href="#"><span
                                class="fs-12 text-muted">Welcome!</span><span class="fs-14">{{ \Auth::user()->full_name ?: \Auth::user()->email }}</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.userProfile')}}"><i
