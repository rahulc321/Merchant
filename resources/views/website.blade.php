                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay="0.2s">Online merchant<br> platform</h1>
                                ...
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Join for
                                    Free</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="courses-actives">
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="./assets_new/img/gallery/featured1.png" alt=""></a>
                        </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="./assets_new/img/gallery/featured2.png" alt=""></a>
                        </div>
                        <div class="properties__caption">
                            <p>User Experience</p>
                            <h3><a href="#">Fundamental of UX for Application design</a></h3>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img src="./assets_new/img/gallery/featured3.png" alt=""></a>
                        </div>
                        <div class="properties__caption">
                            <p>User Experience</p>
                            <h3><a href="#">Fundamental of UX for Application design</a></h3>
        ...
        <div class="container">
            ...
            <div class="team-active">
                <div class="single-cat text-center">
                    <div class="cat-icon">
                        <img src="./assets_new/img/gallery/team1.png" alt="">
                    </div>
                    <div class="cat-cap">
                ...
                <div class="single-cat text-center">
                    <div class="cat-icon">
                        <img src="./assets_new/img/gallery/team2.png" alt="">
                    </div>
                    <div class="cat-cap">
                ...
                <div class="single-cat text-center">
                    <div class="cat-icon">
                        <img src="./assets_new/img/gallery/team3.png" alt="">
                    </div>
                    <div class="cat-cap">
                ...
                <div class="single-cat text-center">
                    <div class="cat-icon">
                        <img src="./assets_new/img/gallery/team4.png" alt="">
                    </div>
                    <div class="cat-cap">
    ...
    <section class="about-area2 fix pb-padding">
        <div class="support-wrapper align-items-center">
            <div class="right-content2">
                <!-- img -->
                <div class="right-img">
                    <img src="./assets_new/img/gallery/about2.png" alt="">
                </div>
            </div>
