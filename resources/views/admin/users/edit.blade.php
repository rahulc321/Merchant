...
@section('title', 'AetherSmart - Edit User')
@section('content')
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" name="type" id="type" required onchange="showFields()"
                                ...
                                <option value="distributor"
                                    ...
                                    <?php if($user->type == 'Installer'){ echo 'selected'; } ?>>Installer
                                </option>
                                </select>
                        </div>
...
const fieldsData = {
    end_user: `
            ...
            <div class="col-md-6">
                ...
                <select class="form-control js-example-basic-multiple" name="devices[]" id="devices" multiple>
                    <option value="">Select</option>
    ...
    distributor: `
        ...
        Installer: `
            <div class="col-md-3">
                ...
                <input type="text" name="full_name" class="form-control" placeholder="Enter installer name" required>
            </div>
            ...
            <div class="col-md-3">
                <label class="form-label">State</label>
                 ...
                 <?php foreach ($timezones as $timezone) { ?>
                  ...
                  <option value="<?=$timezone->state_name?>"><?=$timezone->state_name?></option>
                  <?php } ?>
                  </select>
...
$(document).ready(function() {
    ...
    $.each(user, function(key, value) {
        if (key === 'devices') {
            ...
            $('#devices').val(value).trigger('change');
        } else {
