            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.listCategory')}}">Category</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <a class=" " href="{{route('admin.addContent',[$value->id])}}"><span
                                                        class="badge bg-outline-info">Add Content</span></a>




                                                <a href="{{route('admin.trainingEdit',[$value->id])}}">
